      ...
      <main className="bg-[#0A0A0A]">
        ...
        <section className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8">
              <div className="relative mx-auto h-40 w-40 overflow-hidden rounded-full shadow-2xl ring-4 ring-[#C91F37]/20">
                <Image
            ...
            <h1 className="font-playfair text-4xl font-bold tracking-tight text-gray-100 sm:text-6xl">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link
                href="/speaking"
                className="button-press text-sm leading-6 font-semibold text-gray-300 transition-all duration-300 hover:translate-x-1 hover:text-[#C91F37]"
              >
                View my talks{" "}
                <span
                  aria-hidden="true"
        ...
        <section className="py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col items-start justify-between rounded-2xl bg-gray-900 p-8 ring-1 ring-gray-800 transition-all duration-300 hover:ring-[#C91F37]/50">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {latestTalks.map((talk) => (
                <article
                  key={talk.id}
                  className="flex flex-col rounded-xl border border-gray-800 bg-gray-900 p-6 transition-all hover:border-[#C91F37]/50"
                >
                  ...
                  <div className="mt-4">
                    <Link
                      href="/speaking"
                      className="text-sm font-medium text-[#C91F37] hover:text-[#D3381C]"
                    >
                      View details →
                    </Link>
                  </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {latestPosts.map((post) => (
                <article
                  key={post.id}
                  className="group card-hover stagger-item flex flex-col overflow-hidden rounded-xl border border-gray-800 bg-gray-900 transition-all duration-300 hover:border-[#C91F37]/50"
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <h3 className="mt-3 text-lg leading-6 font-semibold text-gray-100">
                      <Link
                        href={`/blog/${post.slug}`}
                        className="transition-all duration-300 hover:translate-x-1 hover:text-[#C91F37]"
                      >
                        {post.title}
                      </Link>
                    </h3>
