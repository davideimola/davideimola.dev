...
excerpt: "How to configure GitKraken Client to run Git hooks with Husky and Nvm. A practical guide to setting up pre-commit hooks in your favorite Git GUI."
category: "Git"
readTime: "6 min read"
publishDate: "2022-01-08"
tags: ["Git", "GitKraken", "Husky", "Nvm", "Tooling"]
featured: false
heroImage: "https://images.unsplash.com/photo-1627399270231-7d36245355a9?auto=format&fit=crop&w=1974&q=80"
