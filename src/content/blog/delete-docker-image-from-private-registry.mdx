...
excerpt: "A practical guide to deleting Docker images from private registries using Docker's API. Step-by-step instructions for managing your private registry."
category: "Technical"
readTime: "5 min read"
publishDate: "2020-06-12"
tags: ["Docker", "Registry", "DevOps", "API"]
featured: false
heroImage: "https://images.unsplash.com/photo-1605745341112-85968b19335b?auto=format&fit=crop&w=2971&q=80"
