...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    tags: ["Git", "Security", "AI", "Developer Experience"],
    featured: false,
  ...
  },
  {
    ...
    excerpt:
      "Git problems rarely come from missing commands, but from missing visibility into what is really happening in the repository.",
    category: "Git",
    readTime: "2 min read",
    publishDate: "2025-12-20",
    slug: "git-visibility-git-mastery",
    tags: ["Git", "Security", "AI", "Developer Experience"],
    featured: true,
    heroImage: "/images/blog/git-visibility-git-mastery/main-blog.webp",
    heroImageAlt: "Abstract visualization of git clarity and visibility",
  },
];
